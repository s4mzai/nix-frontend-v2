...
const PermErrCtxProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [failedPermissions, setCurrentFailedPerms] = React.useState<Permission[]>([]);
